...
class Warenkorb extends Component {
  ...
  componentDidMount() {
    ...
    tickets = response.data 
      ...
      getWarenkorbInfos.getSnacks().then((response) => console.log(response));

      getWarenkorbInfos.getDrink().then((response) => console.log(response));
                      ...
                      {this.state.Ticket.map((tickets) => (
                        <div className="DESIGNTextField">
                          <div className="KinoTicket">
                            {" "}
                            <div className="WarenkorbTicketReihe">
                              <div className="BeschreibungQWarenkorb">
                                Ticket:{" "}
                              </div>
                              {tickets.vorstellung.film.name}{" "}
                            </div>
                            <div className="WarenkorbTicketReihe">
                              <div className="BeschreibungQWarenkorb">
                                Sitzplatz:
                              </div>{" "}
                              Reihe {tickets.vorstellung.saal.reihe}, Sitzplatz{" "}
                              {tickets.vorstellung.saal.spalte}{" "}
                            </div>{" "}
                            <div className="WarenkorbTicketReihe">
                              <div className="BeschreibungQWarenkorb">
                                Datum:{" "}
                            ...
                            <div className="WarenkorbTicketReihe">
                              ...
                              {tickets.vorstellung.startZeit.substring(11, 16) +
                                " Uhr"}{" "}
                            </div>{" "}
                            <div className="WarenkorbTicketReihe">
                              <div className="BeschreibungQWarenkorb">
                              ...
                              {tickets.vorstellung.grundpreis + " Euro"}{" "}
                            </div>
                          </div>{" "}
                          <br />
                        </div>
