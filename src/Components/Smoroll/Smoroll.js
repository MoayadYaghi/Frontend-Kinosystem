    ...
    render() {
        ...
        return(
            ...
            <div className ="Flex">
                ...
                <div  >       
                    <Menue1/>
                        <div className = "BacktoTop" onClick= {this.scrollToTop}> Zurück an den Start</div>
                    <Menue2/>
                    <div className = "BacktoTop" onClick= {this.scrollToTop}> Zurück an den Start</div>
                    <Menue3/>
                    <div className = "BacktoTop" onClick= {this.scrollToTop}> Zurück an den Start</div>
